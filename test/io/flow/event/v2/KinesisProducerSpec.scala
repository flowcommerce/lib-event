...
import software.amazon.awssdk.services.kinesis.model.{DescribeStreamRequest, DescribeStreamResponse, PutRecordsRequest, PutRecordsResponse, StreamDescription}
