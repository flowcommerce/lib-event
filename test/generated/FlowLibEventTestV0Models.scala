 ...
 * apibuilder 0.15.11 app.apibuilder.io/flow/lib-event-test/latest/play_2_x_json
 */
  ...
  package object json {
    ...
    def jsObjectTestObjectDeleted(obj: io.flow.lib.event.test.v0.models.TestObjectDeleted): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "id" -> play.api.libs.json.JsString(obj.id)
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "test_object_deleted")
    }

    implicit def jsonWritesLibEventTestTestObjectDeleted: play.api.libs.json.Writes[TestObjectDeleted] = {
      new play.api.libs.json.Writes[io.flow.lib.event.test.v0.models.TestObjectDeleted] {
        def writes(obj: io.flow.lib.event.test.v0.models.TestObjectDeleted) = {
          jsObjectTestObjectDeleted(obj)
        }
      }
    }
    ...
    def jsObjectTestObjectUpserted(obj: io.flow.lib.event.test.v0.models.TestObjectUpserted): play.api.libs.json.JsObject = {
      ...
      ) ++ play.api.libs.json.Json.obj("discriminator" -> "test_object_upserted")
    }

    implicit def jsonWritesLibEventTestTestObjectUpserted: play.api.libs.json.Writes[TestObjectUpserted] = {
      new play.api.libs.json.Writes[io.flow.lib.event.test.v0.models.TestObjectUpserted] {
        def writes(obj: io.flow.lib.event.test.v0.models.TestObjectUpserted) = {
          jsObjectTestObjectUpserted(obj)
        }
      }
    }
    ...
    def jsObjectTestEvent(obj: io.flow.lib.event.test.v0.models.TestEvent): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.lib.event.test.v0.models.TestObjectUpserted => jsObjectTestObjectUpserted(x)
        case x: io.flow.lib.event.test.v0.models.TestObjectDeleted => jsObjectTestObjectDeleted(x)
        case other => {
